...
class UserDetailForm(forms.ModelForm):
    ...
    profile_picture = forms.ImageField(widget=forms.FileInput(attrs={'class':'btn', 'id':'inputGroupFileAddon01', 'style':'text-align: center; vertical-align: center; width: 100%; height: 100%;'}))
